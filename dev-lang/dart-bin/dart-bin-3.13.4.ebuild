...
SRC_URI="
	...
	arm? (
		https://storage.googleapis.com/dart-archive/channels/stable/release/${PV}/sdk/dartsdk-linux-arm-release.zip
			-> dartsdk-${PV}-linux-arm.zip
	)
	arm64? (
		https://storage.googleapis.com/dart-archive/channels/stable/release/${PV}/sdk/dartsdk-linux-arm64-release.zip
			-> dartsdk-${PV}-linux-arm64.zip
	)
	riscv? (
		https://storage.googleapis.com/dart-archive/channels/stable/release/${PV}/sdk/dartsdk-linux-riscv64-release.zip
			-> dartsdk-${PV}-linux-riscv64.zip
	)
"
S="${WORKDIR}/dart-sdk"
